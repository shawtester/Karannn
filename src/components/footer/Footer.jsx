...
import { FaInstagram, FaYoutube, FaFacebook } from 'react-icons/fa'; // Imported FaFacebook
    ...
    <footer className="bg-gray-900 text-gray-100 py-16">
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="/TermsandCondition" className="text-gray-300 hover:text-blue-400 transition duration-300 text-lg">Terms and Condition</a>
              </li>
              <li>
                <a href="/Privacy" className="text-gray-300 hover:text-blue-400 transition duration-300 text-lg">Privacy</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-lg">
              Phone 1: <a href="tel:+919315214742" className="text-blue-400 hover:text-blue-300">+919315214742</a>
            </p>
            <p className="text-lg">
              Phone 2: <a href="tel:+919650501998" className="text-blue-400 hover:text-blue-300">+919650501998</a> {/* Added second number */}
            </p>
          </div>
        </div>
        ...
        <div className="flex justify-center mt-12 space-x-8">
          ...
          <a href="https://www.youtube.com/@Supplement_Adda" className="text-gray-300 hover:text-red-300 transition duration-300 transform hover:scale-110">
            <FaYoutube size={28} />
          </a>
